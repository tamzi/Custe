...
import com.tamzi.custe.configureKotlinAndroid
import com.tamzi.custe.disableUnnecessaryAndroidTests
 ...
 * ```
 *
 * Within the `with(target)` block, the `pluginManager` is used to apply several plugins to the project. These plugins include `com.android.library` for Android library support, `org.jetbrains.kotlin.android` for Kotlin support, and `custe.android.lint` for linting.
 *
 * ```
 * with(pluginManager) {
 *     apply("com.android.library")
 *     apply("org.jetbrains.kotlin.android")
 *     apply("custe.android.lint")
 * }
 * ```
 *
